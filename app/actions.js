import  { app, shell, dialog, protocol } from 'electron'
...
export function createActions ({
  ...
  async function onLearMore () {
    await shell.openExternal('https://github.com/HybridWare/hybrid-browser')
  }
  ...
  async function onCreateBookmark (event, focusedWindow) {
    for (const webContents of getContents(focusedWindow)) {
      ...
      const description = `Hybrid Browser - ${url}`
      ...
      const createShortcut = icon => {
        ...
        // TODO: Kyran: OSX doesn't have arguments option. See https://github.com/HybridWare/hybrid-browser/pull/53#issuecomment-705654060 for solution.
